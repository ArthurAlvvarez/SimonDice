...
public class Engine {
	 ...
	 * 
	 * @param _jugador  recibe un objeto de tipo jugador para poder sumar los puntos
	...
	public void start() throws IOException {
		...
		do {
			...
			System.out.println("¿Que quieres hacer?: \n" + "\n1.Jugar en modo facil \n" + "2.Jugar en modo dificil \n"
					+ "3.10 Mejores Jugadores \n"+ "4.Mejor(es) Jugador(es) \n" + "0.Salir \n");
			opcion = sc.nextInt();
			switch (opcion) {
			case 0:
				...
				break;
			case 1:
				score = play(tModo.Facil);
				if (score > jugador1.getPuntuacion()) {
					jugador1.setPuntuacion(score);
				}
				System.out.println("Puntuacion final: " + score);
				break;
			case 2:
				score = play(tModo.Dificil);
				if (score > jugador1.getPuntuacion()) {
					jugador1.setPuntuacion(score * 2);
				}
			    System.out.println("Puntuacion final: " + score * 2);
				break;
			case 3:
